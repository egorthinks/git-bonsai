...
exports.LANG_RAMPS = exports.PALETTE_SIZE = exports.FLOWER = exports.LEAF_B = exports.LEAF_A = exports.SOIL = exports.POT = exports.DEAD = exports.TRUNK = exports.OUTLINE = exports.TRANSPARENT = void 0;
...
exports.LEAF_A = [17, 18, 19, 20];
exports.LEAF_B = [21, 22, 23, 24];
...
function buildPalette(primaryLang, secondaryLang) {
    ...
    for (let i = 0; i < 4; i++) {
        hex(rgb, exports.LEAF_A[i], a.colors[i]);
        hex(rgb, exports.LEAF_B[i], b.colors[i]);
    }
    return rgb;
}
